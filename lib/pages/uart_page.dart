...
class UartDetails extends StatefulWidget {
  bool uartpage1;
  var id;
  UartDetails({required this.uartpage1, required this.id});

  @override
  State<UartDetails> createState() => _UartDetailsState();
}

class _UartDetailsState extends State<UartDetails> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child:
              disable ? const Icon(Icons.play_arrow) : const Icon(Icons.pause),
        ),
