...
class FullDiagnostic extends StatefulWidget {
  bool fullpage4;
  var id;
  FullDiagnostic({required this.fullpage4, required this.id});

  @override
  State<FullDiagnostic> createState() => _FullDiagnosticState();
}

class _FullDiagnosticState extends State<FullDiagnostic> {
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            ...
            if (disable == true) {
              ...
              ////write
              if (widget.fullpage4) {
                var uartCmd = utf8.encode('{"BLE_FDM":""}');
